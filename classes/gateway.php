...
$companyPhone	= $this->companyworkphone;
...
if(is_array($companyPhone))

{

	$con	=	implode(',',$companyPhone);
...
$seven_bit_msg = "Mycotogo NOTIFICATION'".$this->notificationdescription."'";
...
$unicode_msg = 'Mycotogo NOTIFICATION'.$this->notificationdescription;
...
$eight_bit_msg  = "Mycotogo NOTIFICATION'".$this->notificationdescription."'";
