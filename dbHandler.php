...
**/
   ...
   class DataBase

    {
	   ...
	   function DataBase($hName,$hUser,$hPassword,$hdb)
        ...
        */
		...
		function query($qryString)

		 {
		   ...
		   $this->resultResource=mysqli_query($qryString) or die("Not able to execute the query: ".$qryString."  ".mysqli_error());

		   $this->setMaxId(mysqli_insert_id());
	  ...
	  function getResultObject($resource)
...

	   {
	     ...
	     return $this->rowObj=mysqli_fetch_array($resource);
