						...
						<div class="portlet box green">
							...
							<div class="portlet-title manage-consumer">
								...
								<form method="post" action="filehandling.php" >
									...
									<a href="notifications.php?temp=manage#tab_1_4" class="btn lightgreen"><i class="icon-pencil"></i> Add New</a>
									
									<input  type="submit" name="download" class="btn lightgreen" value="Download"/> 

                                    <input  type="submit" name="insert" class="btn lightgreen" value="Insert" /> 
								</form>
								</div>
