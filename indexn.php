	...
	<div class="content">
     ...
     ?-->
			...
			<div class="form-actions">
				...
				<!--a type="submit" class="btn blue pull-right" href="resetpassword.php?token_id=$token"-->

				<!--a type="submit" href="resetpassword.php?token_id=1" name="forgetPassword" class="btn blue pull-right" name="forgetPassword">
					
				Submit <i class="m-icon-swapright m-icon-white"></i>

				</a-->

				<!--a type="submit" class="btn blue pull-right" name="forgetPassword">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<div class="input-icon left">
								...
								<input class="m-wrap placeholder-no-fix" type="text" placeholder="First Name"
									name="firstname" />
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<label class="checkbox">
								...
								<input type="checkbox" name="tnc" /> I agree to the <a href="#">Terms of Service</a> and <a
