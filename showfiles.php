...
if(isset($_POST['sendShareFiles']))
{
	...
	if(mysqli_num_rows($selectattachment)>0)
	{
		...
		print"<script language=javascript>window.location='".URL."showfiles.php?n=".$_POST['consumer_id']."'</script>";
	//die;
}
if(isset($_POST['submit']) && $_POST['submit']!='')
{
	...
	if($folder_id!='')
	{
		...
		$objFile->addFile();
		print"<script language=javascript>window.location='".URL."showfiles.php?n=".$consumer_id."'</script>";
	}
}
...
if(isset($_POST['save']) && $_POST['save']!='')
{
	...
	print"<script>window.location='".URL."showfiles.php?n=".$_POST['consumer_id']."'</script>";
					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom tabbable-full-width">
							...
							<div class="all-notes-area">
								<h4 class="all-notes-area-header <?php if($consumerfilestatus_id=='6') { echo "complete"; } else {echo "pending";}?>"><?php echo "Document Details";if($_SESSION['usertype']!='Consumer') {?>
								...
								<div class="filesNotes<?php echo $folderCount; ?>" style="display:none;">
									<?php 
										...
										{?>
											<input type="hidden" name="filepath" value="<?php echo $folder.$folderName->consumerfolder_id."/"?>" >
												<div class="attach-area">
													...
													<p>To attach your file please chose from the system.</p>
													<div class="submit-area">
														<input type="submit" name="save" value="Add this comment" />
